...
class OpenTelemetryAsyncCallbackHandler(AsyncCallbackHandler):
    ...
    def _create_span(
            ...
            _set_span_attribute(span, "async_span", True)
    ...
    async def on_chain_start(self,
        ...
        _set_span_attribute(span, "async_span", True)
        print("hitting async on_chain_start")
    ...
    async def on_agent_action(self,
                    action: AgentAction,
                    run_id: UUID,
                    parent_run_id: UUID,
                    **kwargs: Any
    ...
    async def on_agent_error(self, error, run_id, parent_run_id, **kwargs):
        self._handle_error(error, run_id, parent_run_id, **kwargs)
